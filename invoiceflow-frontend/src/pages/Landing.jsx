...
import { FileText, TrendingUp, Clock, Shield, ArrowRight, CheckCircle2, Zap, Bell, Lock, Star } from 'lucide-react'
...
export default function Landing() {
  ...
  return (
    <div style={{
      ...
      {/* HERO SECTION */}
      <section id="hero" data-section style={{
        minHeight: '100vh',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        ...
        <div style={{ maxWidth: '56rem', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <a href="/register" style={{
              ...
              transition: 'all 0.3s ease',
              boxShadow: '0 4px 15px rgba(37, 99, 235, 0.4)',
              ':hover': { transform: 'translateY(-3px)', boxShadow: '0 8px 25px rgba(37, 99, 235, 0.6)' }
            }}>
              Start Free Trial →
            </a>
          </div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                borderRadius: '12px',
                transition: 'all 0.3s ease',
                ':hover': { transform: 'translateY(-5px)', background: 'rgba(255, 255, 255, 0.08)' }
              }}>
                <p style={{
                  fontSize: '24px',
                  fontWeight: '900',
                  color: '#60a5fa',
                  marginBottom: '0.5rem',
                  animation: `countUp 2s ease-out ${0.8 + i * 0.1}s both`
                }}>{stat.value}</p>
      ...
      {/* FEATURES */}
      <section id="features" data-section style={{
        padding: '8rem 1.5rem',
            ...
            {[
              ...
              return (
                <div key={i} style={{
                  ...
                  transition: 'all 0.3s ease',
                  textAlign: 'center',
                  animation: `fadeInUp 0.8s ease-out ${0.2 * i}s both`,
                  ':hover': {
      ...
      {/* PRICING */}
      <section id="pricing" data-section style={{
        padding: '8rem 1.5rem',
        position: 'relative',
        zIndex: 10,
        ...fadeInStyle('pricing')
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                transition: 'all 0.3s ease',
                animation: `fadeInUp 0.8s ease-out ${0.3 * i}s both`,
                position: 'relative',
                overflow: 'hidden',
                ':hover': {
                ...
                <ul style={{ marginBottom: '24px', listStyle: 'none', padding: 0 }}>
                  {plan.features.map((f, j) => (
                    <li key={j} style={{
                      ...
                      marginBottom: '12px',
                      color: 'rgba(255, 255, 255, 0.8)',
                      animation: `fadeInLeft 0.5s ease-out ${0.1 * j}s both`
                    }}>
                ...
                <a href="/register" style={{
                  display: 'block',
                  padding: '12px 24px',
                  background: plan.highlight ? 'linear-gradient(90deg, #2563eb, #7c3aed)' : '#3b82f6',
                  borderRadius: '8px',
                  color: 'white',
                  textDecoration: 'none',
                  textAlign: 'center',
                  ...
                  cursor: 'pointer',
                  transition: 'all 0.3s ease',
                  ':hover': { transform: 'translateY(-2px)', boxShadow: '0 4px 15px rgba(59, 130, 246, 0.4)' }
                }}>
                  Get Started
                </a>
              </div>
      ...
      {/* CTA */}
      <section id="cta" data-section style={{
        padding: '8rem 1.5rem',
        textAlign: 'center',
        position: 'relative',
        zIndex: 10,
